...
echo $src
java -jar .lib/compiler.jar --js src/js/base.js --js src/js/alert.js --js src/js/mymarker.js --js src/js/lastmarker.js --js src/js/gmap.js --js src/js/alarm.js --js src/js/config.js --js src/js/geos.js --js src/js/zones.js --js src/js/directions.js --js src/js/maps.js --js src/js/reports.js --js src/js/logs.js --compilation_level=$compilation_level $SRC --js_output_file build/all-min.js --charset utf-8 2>./js.errors.txt
