...
python.exe "%gae%\dev_appserver.py" --port=80 --datastore_path=var\gps-maps27_datastore --history_path=var\gps-maps27_history --high_replication --use_sqlite ./server/
rem log_level
