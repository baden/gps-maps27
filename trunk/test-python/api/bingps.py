...
def add_point(dt):
	...
	packet = struct.pack(PACK_F2,
		...
		3,		# D17	Спутники	Кол-во спутников 3..12
		0,		# D18	Скорость	Скорость в узлах 0..239
		0,		# D19	Скорость дробная часть	Дробная часть скорости 0..99
		0,		# D20	Направление	Направление/2 = 0..179
		0,		# D21	Направление дробная часть	Дробная часть направления 0..99
		0,		# D22, D23	Напряжение внешнего питания	Напряжение/100 = 0..2000	D22 – младшая часть	D23 – старшая часть
		0,		# D24, D25	Напряжение внутреннего аккумулятора	Напряжение/100 = 0..5000	D24 – младшая часть	D25 – старшая часть
		0,		# D26	Зарезервировано	=0
		9,		# D27	Тип точки	Причина фиксации точки
		...
		0,		# D30	Зарезервировано	=0
		0		# D31	Зарезервировано	=0
	)
	return packet
