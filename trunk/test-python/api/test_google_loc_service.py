...
#    print get_location_by_cell(20465, 495, 3, 262)
    a = get_location_by_cell(0x23A1, 0xB82A, 30, 255)
    print get_location_by_cell(0x23A1, 0xB82A, 30, 255)
    print get_location_by_cell(0x4788, 0xB82A, 3, 255)

#    print get_location_by_geo(48.411155999999998, 35.041474999999998)
#    print get_location_by_cell(0x4789, 0xB82A, 99, 30)
#    print get_location_by_cell(0x2000, 0xB82A, 99, 30)
#    print get_location_by_cell(0x0142, 0xB82A, 99, 30)
